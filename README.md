...
- **TL;DR** = one paragraph of plain declarative sentences covering every signal, ordered roughly by rank, ending with any caution/caveat item. Target under ~120–150 words depending on signal count — written for a decision-maker in a rush; keep only what a reader needs to understand and act on each signal. (Tried ASD-STE100 Simplified Technical English 2026-08-03 — clear but reads flat/boring per Dan's call; reverted to this normal style. See RADAR-DEVLOG.md v1.4 and v1.7.)
